...
from services.google_api import get_headers_map, get_services
import streamlit as st

PLANILHA_ID = '1D7TLq7-ThUj5WyUn1Ys3X05jKilDDmYjpLSxngK6ij4'
RANGE_PLANILHA = 'DB Diagnóstico!A:AP'
RANGE_PLANILHA_CLIENTES = 'DB Diagnóstico!A2:A'
RANGE_PLANILHA_WIDTH = 42
...
class Diagnosis_Headers(Enum):
    ...
    DOC_ID = 'ID do documento diagnóstico gerado'
